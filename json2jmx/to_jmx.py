...
def jmeter_test_plan(root_xml):
    ...
    JmeterTestPlan.set('jmeter', '5.4.1')
...
def controller(parent_xml, result):
    ...
    for data in result:
        ...
        TransactionController = etree.SubElement(parent_xml, "TransactionController")
        TransactionController.set("guiclass", "TransactionControllerGui")
        TransactionController.set("testclass", "TransactionController")
        TransactionController.set("testname", data.get("name"))
        TransactionController.set("enabled", "true")

        boolProp = etree.SubElement(TransactionController, "boolProp")
        boolProp.set("name","TransactionController.includeTimers")
        boolProp.text = "false"
        boolProp = etree.SubElement(TransactionController, "boolProp")
        boolProp.set("name","TransactionController.parent")
        boolProp.text = "false"
        stringProp = etree.SubElement(TransactionController, "stringProp")
        stringProp.set("name", "TestPlan.comments")
