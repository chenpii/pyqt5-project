...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(40, 20, 441, 91))
        ...
        self.label_json_dir = QtWidgets.QLabel(self.widget)
        self.label_json_dir.setObjectName("label_json_dir")
        self.horizontalLayout.addWidget(self.label_json_dir)
        self.lineEdit_json_dir = QtWidgets.QLineEdit(self.widget)
        ...
        self.pushButton_json_dir = QtWidgets.QPushButton(self.widget)
        ...
        self.label_jmx_dir = QtWidgets.QLabel(self.widget)
        self.label_jmx_dir.setObjectName("label_jmx_dir")
        self.horizontalLayout_2.addWidget(self.label_jmx_dir)
        self.lineEdit_jmx_dir = QtWidgets.QLineEdit(self.widget)
        ...
        self.pushButton_jmx_dir = QtWidgets.QPushButton(self.widget)
        ...
        self.pushButton_trans = QtWidgets.QPushButton(self.widget)
